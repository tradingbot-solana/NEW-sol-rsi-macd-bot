...
async def get_candles():
    ...
    params = {"address": "So11111111111111111111111111111111111111112", "type": "5m", "currency": "usd", "count": 200}
...
async def main():
    ...
    print(f"🚀 Bot is LIVE | Collateral: ${await drift_user.get_total_collateral():.2f}")
    ...
    while True:
        try:
            ...
            has_position = any(p.market_index == MARKET_INDEX and abs(p.base_asset_amount) > 0 
